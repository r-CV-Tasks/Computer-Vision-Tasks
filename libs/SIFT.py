...
def Sift(image: array, sigma: [float, int] = 1.6, num_intervals: int = 3, assumed_blur: float = 0.5,
...
def generateBaseImage(image: array, sigma: float, assumed_blur: float) -> array:
    """
...
def computeNumberOfOctaves(image_shape: tuple) -> int:
    """
...
def generateGaussianImages(image: array, num_octaves: int, gaussian_kernels: list) -> array:
    """
